...
Revision ID: eff3b5f110a0
Revises: 
Create Date: 2018-01-10 22:18:43.938107
...
def upgrade():
    ...
    op.create_index(op.f('ix_movicecols_addtime'), 'movicecols', ['addtime'], unique=False)
...
def downgrade():
    ...
    op.drop_table('oplog')
    op.drop_index(op.f('ix_movicecols_addtime'), table_name='movicecols')
